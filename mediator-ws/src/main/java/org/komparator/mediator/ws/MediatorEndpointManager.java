...
public class MediatorEndpointManager {
	...
	/** variable to know if the server is secondary */
	...
	/** Get the State of Server - Primary or Secondary */
	...
	public void start() throws Exception {
		try {
			...
			if (wsURL.contains("8071")) {
                		System.out.printf("Primary Mediator %n");
            		}else {
                		System.out.printf("Secondary Mediator %n");
                		isSecondary = true;
            		}
