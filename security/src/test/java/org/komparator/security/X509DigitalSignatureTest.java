...
public class X509DigitalSignatureTest extends BaseTest {
	...
	public void testSignature() throws Exception {
		...
		PrivateKey privateKey = CryptoUtil.getPrivateKeyFromKeyStoreResource(KEYSTORE,
		...
		PublicKey publicKey = CryptoUtil.getX509CertificateFromResource(CERTIFICATE).getPublicKey();
